...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const enneagramProfiles = {
    1: {
      ...
      enemyType: 7,
      enemyName: "ลักษณ์ 7 · กรรมแสวงหา — \"เปรตไอเดีย\"",
      enemyDesc: "คุณอาจรู้สึกปวดขมับกับเพื่อนๆ 'เปรตไอเดีย' (ลักษณ์ 7) ที่ชอบโยนไอเดียใหม่สนุกๆ ออกมาเป็นร้อย แต่ไม่ค่อยลงดีเทลหรือระเบียบปฏิบัติ ความยืดหยุ่นและการทำงานแบบตามใจฉันของพวกเขาอาจกระตุ้นต่อมอยากจัดระเบียบของคุณให้ทำงานหนักขึ้น",
    ...
    7: {
      name: "ลักษณ์ 7 · กรรมแสวงหา — \"เปรตไอเดีย\"",
